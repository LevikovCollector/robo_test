*** Keywords ***
Start
    Set Screenshot Directory    /home/vladimir/Документы/Otus - QA Python/robo_test/tests/screenshots
    Open web browser
...
${ACCOUNT_BLOCK}    css:#account-account
# Страница админа
...
${DELETE_PRODUCT}   css:div.pull-right button[data-original-title='Delete']
${MESSAGE_EDIT_SUCCES}  css:div.alert.alert-success.alert-dismissible
${ALL_TABLE_ROWS}   css:div.table-responsive tbody >tr
